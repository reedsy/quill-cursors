...
export default class QuillCursors {
    ...
    private _touchTimerIds;
    private _quillListeners;
    ...
    private _repositionCursors;
    private readonly _handleCursorTouch;
    private _addQuillListener;
    ...
    private _adjustBoundsForRtl;
    private _getCharacterRectAtCursor;
    private _isRtl;
